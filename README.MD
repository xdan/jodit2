...
### CDN
```xml
<link rel="stylesheet" href="//cdnjs.cloudflare.com/ajax/libs/jodit/2.5.24/jodit.min.css">
<script src="//cdnjs.cloudflare.com/ajax/libs/jodit/2.5.24/jodit.min.js"></script>
```
### USAGE
