...
### CDN
```xml
<link rel="stylesheet" href="//cdnjs.cloudflare.com/ajax/libs/jodit/2.3.19/jodit.min.css">
<script src="//cdnjs.cloudflare.com/ajax/libs/jodit/2.3.19/jodit.min.js"></script>
```
### USAGE
...
Fix [Dom.css][] method bug. That example has not worked.
```javascript
