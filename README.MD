...
### CDN
```xml
<link rel="stylesheet" href="//cdnjs.cloudflare.com/ajax/libs/jodit/2.4.16/jodit.min.css">
<script src="//cdnjs.cloudflare.com/ajax/libs/jodit/2.4.16/jodit.min.js"></script>
```
### USAGE
...
______________________
### 2.4.17
Fix copy-paste html behavior

### 2.4.16
Fixed bug on after type `Enter`

### 2.4.15
Fixed bug with insert `OL` tag and fix Dom module work with Text node
